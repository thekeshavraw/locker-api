...
class Locals {
     ...
     public static config(): any {
          ...
          const mongoDbName = process.env.mongoDbName || 'networkdb';
          const TEMP_SEC_TOKEN = process.env.TEMP_SEC_TOKEN || 'fun2ush';
          const AUTH_SEC_TOKEN = process.env.AUTH_SEC_TOKEN || 'aabrakadabra';

          const mysqlHost = process.env.mysqlHost || 'localhost';
          const mysqlPort = process.env.mysqlPort || '3306';
          const mysqlDbName = process.env.mysqlDbName || 'locker';
          const mysqlDbUser = process.env.mysqlDbUser || 'root';
          const mysqlDbPass = process.env.mysqlDbPass || '';
